    ...
    <Container>
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-x-8">
          <Button href="https://whop.com/emerald-betz/" invert={invert}>
            Join now
          </Button>
          <button
            ref={toggleRef}
...
function Navigation() {
  return (
    <nav className="mt-px text-5xl font-medium tracking-tight text-white font-display">
      <NavigationRow>
        <NavigationItem href="https://whop.com/emerald-betz/">Join Now</NavigationItem>
  ...
  return (
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full fill-[#00ea0826] stroke-neutral-950/5 [mask-image:linear-gradient(to_bottom_left,white_40%,transparent_50%)]"
            yOffset={-96}
            interactive
          />
